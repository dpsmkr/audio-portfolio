...
<body class="bg-gray-100 text-gray-900">
  ...
  <!-- JSX do seu portfólio -->
  <script type="text/babel">

    const { useState, useEffect, useRef } = React;

    function AudioPortfolio() {
      ...
      const years = ["Todos","2025","2024","2023","2022","2021","2020","2019","2018","2017"];
    ...
    ReactDOM.createRoot(document.getElementById('root')).render(<AudioPortfolio />);
